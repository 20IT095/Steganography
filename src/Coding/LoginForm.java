...
public class LoginForm extends javax.swing.JFrame {
   ...
   String MyAppPassword = "   ";
    ...
    private void initComponents() {
        ...
        jTextUserName.setForeground(new java.awt.Color(19, 193, 193));
...
//        jLoginFormActionPerformed(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextUserName.getText().equals("Isha") && jPassword.getText().equals("123")){
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        JOptionPane.showMessageDialog(this, "The Password for user 'Isha' is '123'");
